...
$title = 'Start an app with Angular 12 and Bootstrap 5';
$description = 'Learn how to quickly create a web-app with Angular 12 and Bootstrap 5.';
$date = '2021-05-30';
...
<article>
    <h1>Start an app with Angular 12 and Bootstrap 5</h1>
    <p>Before you start, there's also a <a href="/angular-12-bootstrap-4-start">guide for bootstrap 4 here</a>.</p>
    ...
    <?php highlight('bash', 'ng new ng12b5-example'); ?>
    <p>Replace <code>ng12b5-example</code> with the name of your project.</p>
    ...
    <p>Finally,</p>
    <?php highlight('bash', 'cd ng12b5-example'); ?>
...
@import \'~bootstrap/scss/bootstrap\''); ?>
    ...
    <p>If you only need the bootstrap styles, you can stop reading here. But if you want interactive elements (modals, alerts, etc.), you'll need one of two libraries: <code>ngx-bootstrap</code> by Valor software, or the community project <code>ng-bootstrap</code>. <code>ngx-bootstrap</code> doesn't support bootstrap 5 (yet), but <code>ng-bootstrap</code> does (in beta). So let's use that one:</p>
    <?php highlight('bash', 'ng add @ng-bootstrap/ng-bootstrap@11.0.0-beta.1'); ?>
    ...
    <hr />
    <p>That's it! You can find the example code <a href="https://github.com/jfhr/ng12b5-example">on my github</a>.</p>
    <p>Remember that there's a separate <a href="/angular-12-bootstrap-4-start">guide for bootstrap 4 here</a>.</p>
