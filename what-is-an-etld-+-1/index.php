...
<p>A domain consists of one or more parts separated by periods (in practice, there's pretty much always at least two
    parts). The TLD is the last part. In the domain <code>jfhr.me</code> , the <code>me</code> is the TLD.
</p>
<h2>#2 what is an eTLD?</h2>
<p>The eTLD consists of the last n parts of a domain that are shared between multiple sites from different owners.
